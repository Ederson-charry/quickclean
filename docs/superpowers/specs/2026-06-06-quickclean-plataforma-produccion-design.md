...
- **Motor de asignación quicker↔reserva:** disponibilidad, zona, carga, y la regla `empresa → empleado directo` (§6).
- **Disponibilidad/agenda del quicker:** horarios, ausencias (`LeaveRequest`), capacidad.
