...
const Conciliacion = withSuspense(lazy(() => import("@/features/admin/Conciliacion")));
...
const adminConciliacionRoute = createRoute({
  getParentRoute: () => adminLayoutRoute,
  path: "/admin/conciliacion",
  component: Conciliacion,
});

const adminSolicitudesRoute = createRoute({
  getParentRoute: () => adminLayoutRoute,
  path: "/admin/solicitudes",
  component: AdminSolicitudes,
});

const adminContratosRoute = createRoute({
  getParentRoute: () => adminLayoutRoute,
  path: "/admin/contratos",
  component: Contratos,
});

const adminNominaRoute = createRoute({
  getParentRoute: () => adminLayoutRoute,
  path: "/admin/nomina",
  component: Nomina,
});
